...
declare class JWT {
   ...
   * @param {'HS256' | 'HS512' | 'ES256' | 'RS256'} [algorithm=HS256] The algorithm used to sign the payload, possible values: `HS256`, `HS512`, `ES256`, or `RS256`
   * @returns {Promise<string>} Returns token as a `string`.
   */
  sign(
    payload: object,
    secret: string,
    algorithm?: "HS256" | "HS512" | "ES256" | "RS256"
  ): Promise<string>;
